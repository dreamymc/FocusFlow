<template>
    <div ref="bellContainerRef" class="relative inline-block">
        ...
        <button
            ...
            class="relative p-2 rounded-lg text-text-secondary hover:text-text hover:bg-surface-3 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 active:scale-95 transition-all duration-200 cursor-pointer bell-jiggle"
            ...
            <div class="py-1">
                ...
                <ul v-else class="max-h-80 overflow-y-auto divide-y divide-border/40 scrollbar-thin">
                    <li
                        ...
                        :key="index"
                        class="group px-4 py-3 hover:bg-surface-3 transition-all duration-200 ease-out flex gap-3 align-top cursor-default"
                    >
                        <!-- Event-Specific Icon -->
